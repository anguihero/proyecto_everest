...
* **Titularidad:** Los derechos patrimoniales sobre el código fuente, bases de datos, manuales técnicos y parametrizaciones del juego pertenecen en un 100% a la personería jurídica u organización determinada por el Dueño de Producto (**Óscar**), una vez se liquide la totalidad del costo de desarrollo acordado ($2.400.000 COP).
